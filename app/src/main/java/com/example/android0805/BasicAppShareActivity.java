...
public class BasicAppShareActivity extends AppCompatActivity implements AutoPermissionsListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGalley.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View view) {
                //갤러리 인텐트 생성
    ...
    //권한을 거부 할 때 호출되는 메소드 : AutoPermissionsListener의 메소드
    @Override
    public void onDenied(int i, String[] strings) {
        Toast.makeText(this,"권한 사용을 하지 않으면 기능을 사용 못함",Toast.LENGTH_LONG).show();
    }
    //권한을 허용했을 때 호출되는 메소드 : AutoPermissionsListener의 메소드
    @Override
    public void onGranted(int i, String[] strings) {
        Toast.makeText(this,"권한 사용",Toast.LENGTH_LONG).show();
    }
